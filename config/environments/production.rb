...
Rails.application.configure do
  ...
  # Use in-process memory cache (no separate cache database needed).
  config.cache_store = :memory_store

  # Use async (in-process) job adapter for now. Switch to solid_queue with a
  # dedicated :queue database when background job volume warrants it.
