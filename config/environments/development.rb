...
Rails.application.configure do
  ...
  # Store uploaded files on Azure Blob Storage in development.
  # Falls back to local disk if Azure env vars are not set.
  ...
  # Configure file watcher for Docker containers
